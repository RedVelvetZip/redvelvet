...
function PostDetailPage(props: { post: { title: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; excerpt: string | undefined; }; }) {
  return (
    <Fragment>
      <Head>
