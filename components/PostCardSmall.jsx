  ...
  <div className="bg-white shadow-lg rounded-lg p-0 lg:p-3 pb-12 mb-8">
    ...
    <div className="text-center">
      <Link href={`/post/${post.slug}`} passHref>
        <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-black text-sm font-medium rounded-full text-white px-8 py-3 mb-2 cursor-pointer">Continue</span>
      </Link>
    </div>
  </div>
);
