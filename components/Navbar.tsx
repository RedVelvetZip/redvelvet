                    ...
                    <li className={styles["nav-item"]}>
                        <a href="#" className={styles["nav-link"]}>
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                                className={`${styles["svg-inline--fa"]} ${styles["fa-cat"]} ${styles["fa-w-16"]} ${styles["fa-9x"]}`}
                            >
                                <g className={styles["fa-group"]}>
                                    <path
                                        fill="currentColor"
                    ...
                    <li className={styles["nav-item"]}>
                        <a href="#" className={styles["nav-link"]}>
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 576 512"
                                className={`${styles["svg-inline--fa"]} ${styles["fa-alien-monster"]} ${styles["fa-w-18"]} ${styles["fa-9x"]}`}
                            >
                                <g className={styles["fa-group"]} >
                                    <path
                                        fill="currentColor"
                    ...
                    <li className={styles["nav-item"]}>
                        <a href="#" className={styles["nav-link"]}>
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                                className={`${styles["svg-inline--fa"]} ${styles["fa-space-station-moon-alt"]} ${styles["fa-w-16"]} ${styles["fa-5x"]}`}
                            >
                                <g className={styles["fa-group"]} >
                                    <path
                                        fill="currentColor"
                    ...
                    <li className={styles["nav-item"]}>
                        <a href="#" className={styles["nav-link"]}>
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 640 512"
                                className={`${styles["svg-inline--fa"]} ${styles["fa-space-shuttle"]} ${styles["fa-w-20"]} ${styles["fa-5x"]}`}
                            >
                                <g className={styles["fa-group"]} >
                                    <path
                                        fill="currentColor"
